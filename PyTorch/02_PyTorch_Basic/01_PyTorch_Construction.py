# 01_파이토치 패키지의 기본 구성 https://wikidocs.net/57168

'''

# 파이토치 패키지의 기본 구성
1. torch
: 메인 네임스페이스. 텐서 등 다양한 수학 함수가 포함. Numpy와 유사한 구조.

2. torch.autograd
: 자동 미분을 위한 함수들이 포함. 자동 미분의 on/off를 제어하는 콘텍스트 매니저(enable_grad/no_grad)나 자체 미분 가능 함수를 정의할 때 사용하는 기반 클래스인 'Function'등이 포함.
